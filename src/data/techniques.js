...
export const OBFUSCATION_LAYERS = [
  {
    ...
    impact: 'Changes recognized identifier patterns while preserving protected names',
  ...
  },
  {
    ...
    impact: 'Changes the source representation of compatible string literals',
    supported: ['powershell', 'python', 'bash', 'csharp', 'go'],
  },
  {
    id: 'deadcode',
    ...
    icon: '💀',
    description: 'Insert non-functional statements at recognized safe locations',
    impact: 'Changes output structure and code fingerprint without intended side effects',
    supported: ['powershell', 'python', 'bash', 'csharp', 'go'],
  },
  {
    id: 'antianalysis',
    name: 'Anti-Analysis',
    icon: '🛡️',
    description: 'Add lab-oriented timing and environment checks',
    impact: 'May change runtime behavior depending on the host environment',
  ...
  },
  {
    ...
    icon: '⚔️',
    description: 'Transform compatible strings with a random XOR key and runtime reconstruction',
    impact: 'Reduces directly readable compatible literals; does not guarantee scanner evasion',
    supported: ['powershell', 'python', 'bash', 'csharp', 'go'],
  },
  {
    id: 'controlflow',
    ...
    icon: '🌀',
    description: 'Restructure supported code using a randomized state-machine pattern',
    impact: 'Changes supported control-flow shapes while preserving unsupported constructs',
  ...
  },
  {
    ...
    name: 'AMSI/ETW Patch',
    icon: '🧬',
    description: 'Optional Windows lab patch for AMSI/ETW instrumentation',
    impact: 'Security-sensitive, environment-dependent, and likely to be blocked by endpoint protection',
  ...
  },
  {
    ...
    icon: '🔒',
    description: 'Wrap compatible source in an encoded runtime decoder',
    impact: 'Changes the visible source structure and increases output size and complexity',
    supported: ['powershell', 'python', 'bash', 'csharp', 'go'],
  },
]
